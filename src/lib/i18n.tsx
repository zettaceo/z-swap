...
export const translations = {
  en: {
    ...
    hero: {
      ...
      stat1: "Protocol Functions",
      stat2: "Core System Layers",
      stat3: "Chain Architecture",
      stat4: "Regulatory Alignment",
    },
    whatIs: {
      label: "01 — Protocol Definition",
      title1: "Not a DEX.",
      title2: "A Financial Operating System.",
    ...
    capabilities: {
      ...
      title1: "132 Functions Across",
      title2: "7 Protocol Layers",
    ...
    ecosystem: {
      ...
      title1: "Connected to the",
      title2: "ZETTA Ecosystem",
    ...
    future: {
      ...
      title1: "Built for",
      title2: "Long-Term Infrastructure",
    ...
    cta: {
      ...
      btn1: "Request Early Access",
      btn2: "Read Documentation",
      status: "Protocol Status",
      statusVal: "In Development",
      reg: "Regulatory Focus",
      regVal: "VARA / VASP",
      eco: "Ecosystem",
      ecoVal: "ZETTA Protocol",
    },
    footer: {
  ...
  es: {
    ...
    hero: {
      ...
      stat1: "Funciones del Protocolo",
      stat2: "Capas del Sistema",
      stat3: "Arquitectura Multicadena",
      stat4: "Alineación Regulatoria",
    },
    whatIs: {
      label: "01 — Definición del Protocolo",
      title1: "No es un DEX.",
      title2: "Es un Sistema Operativo Financiero.",
      sub: "Z-SWAP es diseñado como una capa de infraestructura modular dentro del ecosistema ZETTA, con enrutamiento inteligente, análisis IA y gestión integral de riesgos.",
      reg: "Posicionamiento Regulatorio",
      regText: "Z-SWAP está arquitectado con alineación regulatoria como requisito fundamental, con enfoque en marcos como VARA (Dubai) y VASP aplicables.",
    },
    architecture: {
      label: "03 — Arquitectura del Sistema",
      title1: "Visión General de la",
      title2: "Arquitectura del Protocolo",
    ...
    capabilities: {
      ...
      title1: "132 Funciones en",
      title2: "7 Capas del Protocolo",
    ...
    ai: {
      ...
      title1: "ZION IA —",
      title2: "Inteligencia Consultiva",
    ...
    future: {
      ...
      title2: "Infraestructura a Largo Plazo",
    ...
    cta: {
      ...
      btn1: "Solicitar Acceso Anticipado",
      btn2: "Leer Documentación",
      status: "Estado del Protocolo",
      statusVal: "En Desarrollo",
      reg: "Enfoque Regulatorio",
      regVal: "VARA / VASP",
      eco: "Ecosistema",
      ecoVal: "Protocolo ZETTA",
    },
    footer: {
      tagline: "Una capa de infraestructura de liquidez inteligente dentro del ecosistema ZETTA.",
      status: "PROTOCOLO EN DESARROLLO",
      protocol: "Protocolo",
      ecosystem: "Ecosistema ZETTA",
  ...
  zh: {
    ...
    whatIs: {
      ...
      reg: "监管定位",
      regText: "Z-SWAP 的架构以监管对齐为基本要求，特别关注 VARA（迪拜）和适用的 VASP 框架。",
    },
    architecture: {
      label: "03 — 系统架构",
      title1: "协议",
