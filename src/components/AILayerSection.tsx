  ...
  return (
    <section id="ai-layer" className="relative py-12 sm:py-16 md:py-20 lg:py-24 overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        {/* Two-column layout: stacked on mobile, side-by-side from lg */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
          ...
          <div className="glass-card rounded-2xl border border-zs-border overflow-hidden min-w-0">
            ...
            {/* Fixed height terminal — scrolls internally on overflow */}
            <div className="p-4 sm:p-5 font-mono text-[10px] sm:text-[11px] leading-[1.65] h-64 sm:h-80 lg:h-96 overflow-y-auto">
