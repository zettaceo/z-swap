...
const capabilities = [
  ...
  { title: "protocol risk pattern detection", desc: "Pattern-matching against honeypot mechanics, fake marketing, and protocol risk indicators." },
  { title: "transaction scenario simulation", desc: "Simulate historical transaction scenarios using on-chain liquidity data against real on-chain data." },
  { title: "Scenario Simulation",  desc: "Model hypothetical market conditions and evaluate outcomes before committing." },
  { title: "Execution Context Intelligence",  desc: "AI-assisted entry and exit context analysis based on continuous market data evaluation." },
];
