...
const integrations: Integration[] = [
  ...
  { name: "Z-Finance",                type: "Financial Infrastructure", desc: "partner-based fiat infrastructure, compliance infrastructure, and regulated on/off-ramp.",        color: "cyan"   },
  { name: "Z-PAD",                    type: "Launchpad",               desc: "New token launches on Z-PAD enable liquidity pool initialization through ecosystem tools on Z-SWAP with LP lock.",   color: "gold"   },
  { name: "ZETTA Chain",              type: "Settlement Layer",         desc: "Primary settlement network for Z-SWAP transactions with deterministic settlement architecture.",             color: "gold"   },
