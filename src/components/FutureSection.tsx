...
export default function FutureSection() {
  ...
  const phases: Phase[] = [
    ...
    },
    {
      ...
      items: ["Cross-chain swap execution","External DEX aggregation","ZION AI advisory engine (v2)","transaction simulation module","Token creation suite launch","Z-PAY fiat conversion bridge"],
    },
    {
