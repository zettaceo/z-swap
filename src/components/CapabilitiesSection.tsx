...
const layers: Layer[] = [
  { id:"swap",        tag:"Layer 01", title:"Swap & Liquidity",          tagColor:"cyan",   count:27, desc:"Core DEX engine with advanced routing, multi-pool support, MEV protection, and real-time execution simulation.",
    features:["Swap instantâneo multichain","Swap cross-chain nativo","Roteamento inteligente de liquidez","Divisão inteligente de ordens","Slippage dinâmico inteligente","Slippage manual configurável","Swap parcial por porcentagem","Swap reversível por tempo limitado","Swap protegido contra MEV","Swap protegido contra front-running","Liquidez concentrada (v3 style)","Liquidez tradicional AMM clássico","Pools dinâmicos por par","Criação assistida de pools","Fee dinâmica por pool","Fee personalizada por token","Composição programável de incentivos","Liquidez bloqueável por tempo","Liquidez programável (vesting)","Liquidez com múltiplos provedores","Visualização profunda de pools","Remoção parcial de liquidez","Remoção programada de liquidez","Simulação de swap antes da execução","Histórico detalhado de swaps","Swap via contrato inteligente direto","Swap com fallback de liquidez"]},
  { id:"analytics",   tag:"Layer 02", title:"Market Intelligence",        tagColor:"violet", count:22, desc:"Professional-grade analytics: detect abnormal liquidity patterns, monitor whales, simulate transaction scenarios, and set precision alerts.",
    features:["Gráficos avançados integrados","Volume real vs volume artificial","Detector de padrões anômalos de liquidez","Detector de bots de arbitragem","Detector de honeypot","Detector de taxas abusivas","Análise de holders em tempo real","Análise de concentração de supply","Histórico completo on-chain","Análise de liquidez histórica","Comparador de tokens","Comparador de pools","Alertas de preço inteligentes","Alertas de liquidez","Alertas de movimentação suspeita","Simulação de cenários operacionais","Simulação de entrada e saída","Comparação manual de operações","Ranking de tokens","Ranking de traders","Análise de risco automática","Score de confiança do token"]},
  { id:"ai",          tag:"Layer 03", title:"ZION AI & Automation",       tagColor:"gold",   count:21, desc:"ZION AI assists users with market analysis and advisory functions. All suggestions require manual user review.",
    features:["AI-assisted liquidity opportunity analysis","early risk pattern detection","Monitoramento contínuo Zion","privacy-oriented execution modes","Simulação reversa de swap","Simulação IA pré-swap","Análise personalizada de cenários de liquidez","Modo conservador de operação","Modo avançado de operação","Modo institucional","IA de leitura de contrato","IA de leitura de liquidez","IA de leitura de comportamento de holders","IA de leitura de marketing fake","Análise de execução assistida por IA","Sugestão dinâmica de slippage","IA de contexto operacional de entrada","IA de contexto operacional de saída","Aprendizado contínuo com dados de mercado","Painel de controle da IA","Logs explicáveis da IA"]},
  { id:"security",    tag:"Layer 04", title:"Security & Privacy",         tagColor:"red",    count:20, desc:"Comprehensive on-chain security: MEV protection, anti-sandwich, privacy mode, continuous AI auditing.",
    features:["Anti-MEV nativo","Anti-front running avançado","Multisig inteligente","Time-lock configurável","Freeze seletivo de tokens","Blacklist dinâmica programável","Whitelist configurável","Monitoramento on-chain 24/7","Auditoria contínua por IA","Alertas de segurança em tempo real","Proteção contra contratos maliciosos","Proteção contra proxies suspeitos","Modo privacidade total","Ocultação de rotas de swap","Logs criptografados","Execução com delay aleatório","Proteção contra sandwich attack","Painel de risco por usuário","Painel de risco por token","Histórico de incidentes"]},
  { id:"token",       tag:"Layer 05", title:"Token Creation",             tagColor:"cyan",   count:18, desc:"Full-featured token deployment suite integrated with Z-PAD, with anti-bot launch and automated LP lock.",
    features:["Criador de tokens avançado","Templates auditados","Taxas configuráveis (buy/sell/transfer)","Lock de liquidez nativo","Vesting inteligente","Fair launch","Launch privado","Launch público","Anti-bot launch","Protected launch controls","Gerenciador de holders","Controle de mint/burn","Controle de pausas","Gerador de contratos verificados","Integração com Z-PAD","Painel do criador","Histórico de launches","Rating de projetos"]},
  { id:"governance",  tag:"Layer 06", title:"Governance & DAO",           tagColor:"violet", count:14, desc:"On-chain governance: staked voting, delegation, hybrid DAO, and proposal analysis interface.",
    features:["Governança on-chain","Propostas de melhoria","Votação ponderada por stake","Delegação de votos","Governança por reputação","DAO híbrida (on/off-chain)","Mecanismos programáveis de penalidade","Incentivos por participação","Ranking de contribuidores","Tesouraria governada","Execução validada de propostas","Histórico de votações","Alertas de governança","Painel DAO"]},
